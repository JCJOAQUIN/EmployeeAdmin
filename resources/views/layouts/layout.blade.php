...
<body class="bg-light">
    @section('navbar')
        <header>
            <div></div>
            <div class="bg-primary grid grid-cols-3 w-full h-14 content-center">
                ...
                <div class="text-light md:text-xl text-md text-right mr-12 grid md:grid-cols-4 grid-cols-1">
                    <div class="col-span-1 md:col-start-3 col-start-2 text-center">
                        <a href="#"><button class="h-10 w-full hover:bg-third" type="button">About</button></a>
                    </div>
                    <div class="col-span-1 md:col-start-4 col-start-2 text-center">
                        <a href="#"><button class="h-10 w-full hover:bg-third" type="button">Help</button></a>
                    </div>
                </div>
            </div>
        </header>
	...
	<div class="grid grid-cols-11 mt-12">
		...
		<div class="col-span-4 col-start-7 rounded-md bg-lightSoft">
			...
			<div class="flex justify-center">
				<img class="w-3/4" src="{{URL::asset('http://localhost/employeeadmin/public/img/3293477.jpg')}}" alt="Image">
			</div>
		</div>
	</div> --}}
